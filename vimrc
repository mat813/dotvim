...
Plug 'https://github.com/tpope/vim-cucumber'
...
Plug 'https://github.com/timcharper/textile.vim'
Plug 'https://github.com/vim-scripts/dbext.vim'
Plug 'https://github.com/godlygeek/tabular'
Plug 'https://github.com/mileszs/ack.vim'
Plug 'https://github.com/vim-ruby/vim-ruby'
Plug 'https://github.com/hallettj/jslint.vim'
Plug 'https://github.com/vim-scripts/project.tar.gz'
Plug 'https://github.com/vim-scripts/Align'
Plug 'https://github.com/vim-scripts/matchit.zip'
Plug 'https://github.com/vim-scripts/Vimball'
Plug 'https://github.com/vim-scripts/Visual-Mark'
Plug 'https://github.com/vim-scripts/ruby-matchit'
...
Plug 'https://github.com/lucapette/vim-jquery-doc'
Plug 'https://github.com/lucapette/vim-ruby-doc'
Plug 'https://github.com/vim-scripts/ikiwiki-nav'
...
Plug 'https://github.com/wlangstroth/vim-haskell'
Plug 'https://github.com/pangloss/vim-javascript'
Plug 'https://github.com/cakebaker/scss-syntax.vim'
Plug 'https://github.com/mmalecki/vim-node.js'
Plug 'https://github.com/ajf/puppet-vim'
Plug 'https://github.com/Absolight/Bird-Syntax'
...
Plug 'https://github.com/Absolight/vim-bind'
Plug 'https://github.com/rhowardiv/nginx-vim-syntax'
...
Plug 'https://github.com/kusabashira/mojo.vim'
Plug 'https://github.com/saltstack/salt-vim'
Plug 'https://github.com/kien/tabman.vim'
